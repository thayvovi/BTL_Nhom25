...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="index.php?controller=bus&action=update_bus&id=<?php echo $_GET['id']; ?>" method="post" class="row g-3">
              <div class="col-md-6">
            ...
            if ($bus->idRoute == $route->id) {
              ...
              <?php foreach ($buses as $bus) { ?>
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control" name="ngay" value="<?php echo $bus->date; ?>" >
                </div>
                <div class="mt-2 col-md-6">
                  <label class="form-label">Giờ đi</label>
                  <input type="time" class="form-control" name="gio" value="<?php echo $bus->time; ?>" >
                </div>
                <div class="mt-2 col-md-6">
