        ...
        <div class="card-body">
            <form action="index.php?controller=route&action=store" method="post" class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" name="routeName" class="form-control" value="<?php echo $routes->routeName; ?>">
              </div>
              <div class="mt-2 col-md-6">
                <label class="form-label">Số xe chạy</label>
                <input type="text" class="form-control" name="bus" value="<?php echo $routes->totalBus; ?>">
              </div>
